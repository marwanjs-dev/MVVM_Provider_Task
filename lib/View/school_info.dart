        ...
        builder: (context, value, child) => SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              reusableTextField(value.schoolName, Icons.school),
              const SizedBox(
                height: 15,
              ),
              reusableTextField(value.schoolAddress, Icons.location_on_rounded),
              const SizedBox(
                height: 15,
              ),
              reusableTextField(value.studentsNo, Icons.person),
              const SizedBox(
                height: 15,
              ),
              reusableTextField(value.teachersNo, Icons.person),
              Padding(
                padding:
